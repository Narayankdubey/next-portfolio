...
import { ArrowLeft, Calendar, Clock, User, Heart, MessageCircle, Send, Share2, Volume2, VolumeX, Square, Languages, Copy, Check } from "lucide-react";
            ...
            {showShareMenu && (
              <div className={styles.shareMenu}>
                ...
                <button onClick={handleCopyLink} className={styles.shareOption}>
                  {copied ? <Check className={styles.shareIcon} /> : <Copy className={styles.shareIcon} />}
          ...
          <div className={styles.actionGroup}>
            {!isReading ? (
              ...
              <>
                ...
                >
                  {isPaused ? <Volume2 className={styles.actionIcon} /> : <VolumeX className={styles.actionIcon} />}
